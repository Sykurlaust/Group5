			...
			<div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 lg:grid-cols-4">
				<div className="space-y-4">
					...
					<div className="flex gap-3 text-gray-600">
						<a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#2dbe8b] transition-colors" aria-label="Instagram">
						...
						<a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#2dbe8b] transition-colors" aria-label="Facebook">
							<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
								<path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
							</svg>
						</a>
						<a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#2dbe8b] transition-colors" aria-label="LinkedIn">
							<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
								<path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/>
							</svg>
						</a>
						<a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#2dbe8b] transition-colors" aria-label="GitHub">
							<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
				...
				<div className="space-y-2 text-sm">
					...
					<Link to="/about" className="block hover:text-[#2dbe8b] transition-colors">About</Link>
				</div>
				<div className="space-y-2 text-sm">
					<p className="font-semibold text-gray-600">Explore</p>
					<Link to="/home" className="block hover:text-[#2dbe8b] transition-colors">Home</Link>
					<Link to="/rent" className="block hover:text-[#2dbe8b] transition-colors">Rent</Link>
					<Link to="/contact" className="block hover:text-[#2dbe8b] transition-colors">Contact</Link>
				</div>
				<div>
